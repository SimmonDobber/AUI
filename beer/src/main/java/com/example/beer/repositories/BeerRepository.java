...
public interface BeerRepository extends JpaRepository<Beer, Long> {
    ...
    @Query(value = "select public.beers.name from public.beers where public.beers.brand_id = :id", nativeQuery = true)
    List<String> getAllNamesByBrandId(@Param("id") Long id);
